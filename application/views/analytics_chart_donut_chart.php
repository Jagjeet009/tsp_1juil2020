...
?>
		...
		<div id="<?php echo $rand ?>" class="columnchart_values" style="width: 99%; height:99%; height: -webkit-fill-available;">Chart</div>
		...
		<script type="text/javascript">
			...
			function drawMultSeries<?php echo $rand ?>() {
				...
				google.visualization.events.addListener(chart, 'ready', function () {
					//$('#columnchart_values_img').html('<img src="' + chart.getImageURI() + '">');
					//$('#columnchart_values_img').html(chart.getImageURI());
				});
				chart.draw(data, options);
				c.innerHTML=c.innerHTML+'<img style="display:none" src="' + chart.getImageURI() + '">';
			}
		</script>
		<!--<div id="columnchart_values_img"></div>-->
