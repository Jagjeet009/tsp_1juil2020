...
$route['survey/analytics/word_cloud/(:any)']='survey/word_cloud/$1';
...
$route['survey/get_survey_elements_list/(:any)']='survey/get_survey_elements_list/$1';
$route['survey/get_survey_elements_list_all/(:any)']='survey/get_survey_elements_list_all/$1';
$route['survey/r_software']='survey/r_software';
$route['survey/get_survey_code2/(:any)']='survey/get_survey_code2/$1';
$route['survey/save_wizard_code']='survey/save_wizard_code';
$route['survey/get_survey_code/(:any)']='survey/get_survey_code/$1';
$route['survey/save_wizard_updated_code']='survey/save_wizard_updated_code';
